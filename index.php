...
<head>
    ...
    <meta property="og:image" content="//m.maite.online/static/images/atrisk.png">
    <meta property="og:url" content="//m.maite.online/">
    <meta name="image" content="//m.maite.online/static/images/atrisk.png"/>
    <meta name="imageUrl" content="//m.maite.online/static/images/atrisk.png"/>
    ...
    <script src="static/libs/template-web.js"></script>
    <script src="static/libs/html2canvas-alpha.js"></script>
</head>
<body>
        ...
        <div class="page-cont J_page_cont">
            <div class="page-init J_pages page_0 page-current">
                <div class="page-load">
                    <div class="loadWrap">
                        <div class="loadBg">
                            <img src="static/images/logo.png" srcset="static/images/logo@2x.png 400w" />
                        </div>
                        <div class="loadAnim J_load_anim"></div>
                        <div class="loadTop clearfix">
                            <div class="loadBarWrap">
                                <div class="loadBarScroll J_loadBg" style="width: 0"></div>
                            </div>
                            <div class="loadTxt J_loadTxt"></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="page-init J_pages page_1">
                <div class="page-login">
                    <div class="loginBanner J_login_banner"></div>
                    <div class="loginBox clearfix">
                        <div class="inputBox">
                            <input class="inputUser J_input_user" type="text" placeholder="点击输入昵称" />
                            <span class="iconTips J_login_tips"></span>
                        </div>
                        <div class="inpuBtn">
                            <a href="javascript:void(0);" class="loginStart J_btn_login">冒险开始</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="page-init J_pages page_2">
                <div class="page-main" id="J_scene_main"></div>
            </div>
            <div class="page-init page-wide J_pages page_3">
                <div class="page-question" id="J_page_qustion">
                </div>
            </div>
            <div class="page-init page-wide J_pages page_4" id="J_page_results"></div>
            <div class="page-init page-wide J_pages page_5 page-screen-3" id="J_page_shareimg"></div>
            <div class="musicWrap J_music_wrap">
                <span class="icon-music J_audioImg">
                    <img src="static/images/icon_music.png" srcset="static/images/icon_music@2x.png 400w" />
                </span>
            </div>
        </div>
        <div class="reveal-modal-cont J_layer_cont">
            ...
            <div class="reveal-qrimg J_layer_qrimg">
                <div class="shot-wrap">
                    ...
                    <span class="qrcode-close icon-x J_qrcode_close"></span>
                </div>
            </div>
        </div>
